    ...
    <el-card class="demo-card">
      ...
      <el-card class="section-card" shadow="never" style="margin-top: 20px">
        ...
        <div>
          ...
          <el-button @click="handleToggleTheme" type="primary">
            切换主题
          </el-button>
          <el-button @click="handleSetLightTheme" size="small">
            设置为亮色
          </el-button>
          <el-button @click="handleSetDarkTheme" size="small">
            设置为暗色
          </el-button>
        </div>
      </el-card>
